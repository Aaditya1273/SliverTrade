# SilverTrade AI Cache Architecture Audit

**Date:** 2026-02-22
**Scope:** All in-memory caching, persistence, eviction, concurrency, fault tolerance, and security
**Codebase:** SilverTrade AI (Flask + React 19 algorithmic trading platform)
...
- `db/silvertrade.db` — Auth, settings, strategies, symbols, users
...
| Volumes | `silvertrade_db` persists SQLite databases across container restarts |
...
| L4 | **Static Fernet encryption salt** | `auth_db.py:60` | `b"silvertree_static_salt"` — functional but reduces KDF diversity | LOW |
