...
SilverTrade supports 30+ Indian stock brokers and 1 crypto exchange (Delta Exchange), with more crypto exchanges planned. The current frontend treats all brokers uniformly, presenting a mixed UI where:
...
{
    "Plugin Name": "zerodha",
    "Description": "Zerodha SilverTrade AI Plugin",
    "Version": "1.0",
    "Author": "Rajandran R"
}
```
...
- **Done**:
  - Bruno collections split into `collections/silvertrade/IN_stock/` and `collections/silvertrade/crypto/`
...
```json
{
    ...
    "Description": "Delta Exchange SilverTrade AI Plugin",
    "Version": "1.0",
...
```json
{
    ...
    "Description": "Firstock SilverTrade AI Plugin",
    "Version": "1.0",
    "Author": "Rajandran R",
    "broker_type": "stock",
...
{
    "Plugin Name": "groww",
    "Description": "Groww SilverTrade AI Plugin",
    "Version": "1.0",
    "Author": "Rajandran R",
    "broker_type": "stock",
