...
### Test numba/scipy
```bash
docker exec silvertrade python -c "import numba, llvmlite, scipy; print('✓ Working')"
```

### Test Strategy Indicators
```bash
docker exec silvertrade python -c "
...
2. Verify volumes: `docker inspect silvertrade`
3. Test imports: `docker exec silvertrade python -c "import numba, scipy"`
4. Join Discord: https://discord.com/invite/UPh7QPsNhP
5. GitHub Issues: https://github.com/silvertrade/silvertrade/issues
