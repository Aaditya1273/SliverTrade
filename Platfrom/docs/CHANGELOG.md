...
All notable changes to SilverTrade AI will be documented in this file.
...
- Order field names aligned with SilverTrade AI schema
...
- What is SilverTrade, Key Concepts, System Requirements
...
- SilverTrade AI symbol format reference
...
### Other Documentation
- Why Build with SilverTrade AI guide
...
- `db/silvertrade.db` - Main database (users, orders, settings)
...
See [GitHub Releases](https://github.com/silvertrade/silvertrade/releases) for previous version history.
...
- **YouTube**: https://www.youtube.com/@silvertrade
