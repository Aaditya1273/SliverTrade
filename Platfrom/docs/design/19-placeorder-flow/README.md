...
The PlaceOrder API is the core order execution endpoint in SilverTrade AI. It handles order validation, authentication, broker routing, and response processing through multiple layers.
...
│  │                                                                      │    │
│  │  A. Transform Data                                                   │    │
│  │     SilverTrade AI Format → Broker Format                                  │    │
│  │                                                                      │    │
│  │     Input:                          Output:                          │    │
...
|-------|------|-------------|
| apikey | string | SilverTrade AI API key |
...
| Invalid API key | 403 | `{"status": "error", "message": "Invalid silvertrade apikey"}` |
