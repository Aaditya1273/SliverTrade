...
Each broker in SilverTrade AI follows a standardized folder structure with consistent interfaces for authentication, order management, data retrieval, and symbol mapping.
...
Convert SilverTrade AI format to broker format.
...
def transform_response(response):
    """Transform broker response to SilverTrade AI format"""
    return {
...
def get_symbol(symbol, exchange):
    """Get broker symbol from SilverTrade AI symbol"""
    pass
...
| SilverTrade AI | Zerodha | Dhan | Angel |
|----------|---------|------|-------|
