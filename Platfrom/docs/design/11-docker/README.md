...
# View logs
docker logs -f silvertrade

# Stop container
docker stop silvertrade

# Remove container
docker rm silvertrade
```
...
> **Reference**: See [GitHub Issue #822](https://github.com/silvertrade/silvertrade/issues/822) for details on the RLIMIT_NPROC fix.
