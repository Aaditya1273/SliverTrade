...
Ngrok creates secure tunnels to expose your local SilverTrade AI instance to the internet, enabling webhook integrations from TradingView, Chartink, and other external services.
...
| Connection refused | Ensure SilverTrade AI is running |
