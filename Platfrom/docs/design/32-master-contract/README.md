...
Master contracts contain symbol mappings between SilverTrade's standardized format and broker-specific formats. They are downloaded daily and cached for fast symbol resolution.
...
│  │  3. Transform to SilverTrade AI format                                     │   │
...
│ symbol       │ VARCHAR      │ SilverTrade AI symbol format           │
