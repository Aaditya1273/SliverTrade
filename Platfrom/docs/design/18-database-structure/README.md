...
SilverTrade uses **5 separate databases** for data isolation, performance optimization, and specialized use cases. This separation prevents contention and allows each database to be optimized for its specific workload.
...
│                                                                              │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐             │
│  │   silvertrade.db   │  │    logs.db      │  │   latency.db    │             │
...
## Database 1: Main Database (silvertrade.db)
...
│ overhead_ms      │ FLOAT        │ SilverTrade AI overhead│
...
| overhead_ms | Total SilverTrade AI overhead |
