...
The utils directory contains shared utility functions used across the SilverTrade AI platform for authentication, logging, configuration, and common operations.
