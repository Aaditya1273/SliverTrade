...
SilverTrade supports Time-based One-Time Password (TOTP) for two-factor authentication. Users can enable 2FA through QR code scanning with authenticator apps like Google Authenticator, Authy, or Microsoft Authenticator.
...
│  │  otpauth://totp/SilverTrade AI:user@example.com?secret=...&issuer=SilverTrade│   │
│  │           │                                                          │   │
│  │           ▼                                                          │   │
...
def get_provisioning_uri(secret, email, issuer="SilverTrade AI"):
...
```json
{
    ...
    "data": {
        ...
        "provisioning_uri": "otpauth://totp/SilverTrade AI:user@example.com?secret=JBSWY3DPEHPK3PXP&issuer=SilverTrade"
    }
}
```
