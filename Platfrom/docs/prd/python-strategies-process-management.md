...
def start_strategy(strategy_id):
    ...
    # Prepare environment
    env = os.environ.copy()
    env['SILVERTRADE_APIKEY'] = get_api_key()
    env['SILVERTRADE_HOST'] = get_host_url()
...
> **Reference**: [GitHub Issue #822](https://github.com/silvertrade/silvertrade/issues/822) documents the RLIMIT_NPROC fix.
