...
├── flow_silvertrade_client.py     # SilverTrade AI API wrapper (~500 lines)
...
| `FlowSilverTradeClient` | Wraps SilverTrade AI internal APIs |
...
def execute_workflow(
    ...
    # 3. Create executor with SilverTrade AI client
    client = FlowSilverTradeClient(api_key)
...
## FlowSilverTradeClient

Wraps internal SilverTrade AI APIs.
