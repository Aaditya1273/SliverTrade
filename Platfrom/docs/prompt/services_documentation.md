# SilverTrade AI Services Documentation

## Overview

SilverTrade Services are Python functions that provide programmatic access to trading operations. These services mirror the functionality of the SilverTrade AI SDK but are designed for internal use within the SilverTrade AI application. Each service function accepts the same request parameters and returns the same responses as documented in the SilverTrade AI SDK.
...
**Location:** `silvertrade/services/place_order_service.py`
...
| api_key | str | Conditional | SilverTrade AI API key (for API-based calls) |
...
**Location:** `silvertrade/services/place_smart_order_service.py`
...
| api_key | str | Conditional | SilverTrade AI API key |
...
**Location:** `silvertrade/services/place_options_order_service.py`
...
**Location:** `silvertrade/services/options_multiorder_service.py`
...
**Location:** `silvertrade/services/basket_order_service.py`
...
**Location:** `silvertrade/services/split_order_service.py`
...
**Location:** `silvertrade/services/modify_order_service.py`
...
**Location:** `silvertrade/services/cancel_order_service.py`
...
**Location:** `silvertrade/services/cancel_all_order_service.py`
...
**Location:** `silvertrade/services/close_position_service.py`
...
**Location:** `silvertrade/services/orderstatus_service.py`
...
**Location:** `silvertrade/services/openposition_service.py`
...
**Location:** `silvertrade/services/quotes_service.py`
...
**Location:** `silvertrade/services/depth_service.py`
...
**Location:** `silvertrade/services/history_service.py`
...
**Location:** `silvertrade/services/intervals_service.py`
...
**Location:** `silvertrade/services/symbol_service.py`
...
**Location:** `silvertrade/services/search_service.py`
...
**Location:** `silvertrade/services/expiry_service.py`
...
**Location:** `silvertrade/services/instruments_service.py`
...
| api_key | str | Yes | SilverTrade AI API key |
...
**Location:** `silvertrade/services/option_symbol_service.py`
...
**Location:** `silvertrade/services/option_chain_service.py`
...
**Location:** `silvertrade/services/synthetic_future_service.py`
...
**Location:** `silvertrade/services/option_greeks_service.py`
...
**Location:** `silvertrade/services/funds_service.py`
...
**Location:** `silvertrade/services/margin_service.py`
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| apikey | str | Yes | SilverTrade AI API key |
...
**Location:** `silvertrade/services/orderbook_service.py`
...
**Location:** `silvertrade/services/tradebook_service.py`
...
**Location:** `silvertrade/services/positionbook_service.py`
...
**Location:** `silvertrade/services/holdings_service.py`
...
**Location:** `silvertrade/services/market_calendar_service.py`
...
**Location:** `silvertrade/services/analyzer_service.py`
...
The Telegram Alert Service provides automated notifications for order-related events via Telegram. This service is not part of the SDK yet but is available for internal use within SilverTrade AI.

**Location:** `silvertrade/services/telegram_alert_service.py`
