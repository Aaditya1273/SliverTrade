...
To install the SilverTrade AI Python library, use pip:
...
pip install silvertrade[indicators]  
```

### Get the SilverTrade AI apikey

Make Sure that your SilverTrade AI Application is running. Login to SilverTrade AI Application with valid credentials and get the SilverTrade AI apikey

For detailed function parameters refer to the [API Documentation](https://docs.silvertrade.ai/api-documentation/v1)

### Getting Started with SilverTrade

First, import the `api` class from the SilverTrade AI library and initialize it with your API key:
...
```python
import silvertrade 
silvertrade.__version__
```

### Examples

Please refer to the documentation on [order constants](https://docs.silvertrade.ai/api-documentation/v1/order-constants), and consult the API reference for details on optional parameters
...
# Initialize SilverTrade AI client
client = api(
    api_key="your_api_key",                  # Replace with your actual SilverTrade AI API key
...
```
GET https://docs.silvertrade.ai/trading-platform/python.md?ask=<question>
```
