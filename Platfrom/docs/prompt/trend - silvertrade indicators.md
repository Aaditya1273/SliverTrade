...
Trend indicators help identify the direction and strength of market trends. All examples use real market data fetched via SilverTrade AI API.

### Data Setup

```python
from silvertrade import api, ta
import pandas as pd
...
This documentation demonstrates how to use SilverTrade AI trend indicators with real market data fetched via the SilverTrade AI API, maintaining pandas DataFrame structure throughout the analysis process.
...
```
GET https://docs.silvertrade.ai/trading-platform/python/indicators/trend.md?ask=<question>
```
