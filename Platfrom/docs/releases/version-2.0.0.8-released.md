...
API docs: <https://docs.silvertrade.ai/api-documentation/v1/orders-api/placegttorder>
...
```
GET https://docs.silvertrade.ai/change-log/release/version-2.0.0.8-released.md?ask=<question>
```
