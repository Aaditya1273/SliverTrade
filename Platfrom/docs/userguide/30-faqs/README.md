...
SilverTrade is an open-source algorithmic trading platform that connects various trading platforms (TradingView, Amibroker, Python) to Indian stock brokers through a unified API.

### Is SilverTrade AI free?

Yes, SilverTrade AI is completely free and open-source. You can download, use, and modify it without any cost.

### Which brokers are supported?

SilverTrade supports 29 Indian brokers including:
- Zerodha
- Angel One
- Dhan
- Upstox
...
### Can I use SilverTrade AI for live trading?

Yes, SilverTrade AI supports live trading with real money. However, we strongly recommend:
...
### Can I run SilverTrade AI on a VPS/Cloud?

Yes, SilverTrade AI can run on:
- AWS EC2/Lightsail
- Google Cloud
- DigitalOcean
- Azure
...
Most Indian brokers require daily authentication for security. This is a broker requirement, not an SilverTrade AI limitation.

### Can I use multiple brokers?

Currently, SilverTrade AI supports one broker at a time. You can switch between brokers by changing the configuration.
...
Typical latency:
- SilverTrade AI processing: 5-20ms
- Broker API: 50-200ms
- Total: 100-500ms
...
Yes, SilverTrade AI fully supports F&O trading. Use correct symbol format:
- Futures: `NIFTY30JAN25FUT`
- Options: `NIFTY30JAN2521500CE`

### What is Analyzer Mode?

Analyzer Mode is SilverTrade's sandbox testing environment. It simulates trading with ₹1 Crore sandbox capital using real market prices but no real money.

### Can I backtest strategies?

SilverTrade is primarily for live trading and walkforward testing strategies. For backtesting:
- Use TradingView's strategy tester
- Use Amibroker's backtesting
- Use Python backtesting libraries

### What happens if SilverTrade AI crashes during a trade?
...
### How do I connect TradingView to SilverTrade?

1. Enable SilverTrade AI accessible via internet (ngrok/cloud)
2. Create webhook alert in TradingView
3. Use SilverTrade AI endpoint URL
...
Report security vulnerabilities to: security@silvertrade.ai (or via GitHub private advisory)
...
SilverTrade is community-driven. Get help through:

1. Documentation: [https://docs.silvertrade.ai](https://docs.silvertrade.ai)
2. Discord Community: [https://silvertrade.ai/discord](https://silvertrade.ai/discord)
3. GitHub Issues: [https://github.com/silvertrade/silvertrade/issues](https://github.com/silvertrade/silvertrade/issues)
...
### Is SilverTrade AI really free?

Yes, SilverTrade AI is 100% free and open-source under the AGPL license.

### Are there any hidden costs?

No hidden costs from SilverTrade AI. You may have:
...
### "SilverTrade is a trading bot"

SilverTrade is a **bridge/platform**, not a trading bot. It connects your strategy signals to your broker. You still need to create or use existing strategies.

### "I can make guaranteed profits"

No trading system guarantees profits. SilverTrade AI is a tool - your results depend on your strategy.

### "It works without internet"

SilverTrade requires internet connection to communicate with brokers and receive signals.

### "I can trade after market hours"

SilverTrade follows exchange timings. F&O can be traded during extended hours as per exchange rules.
...
2. Check [GitHub Discussions](https://github.com/silvertrade/silvertrade/discussions)
