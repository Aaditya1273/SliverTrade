# 01 - What is SilverTrade?

## Introduction

**SilverTrade** is a free, open-source algorithmic trading platform that bridges your trading ideas with execution. Built with Python Flask and a modern React frontend, it provides a unified API layer across 29 Indian brokers, enabling seamless automation from TradingView, Amibroker, Python scripts, Excel, and AI agents.

**Website**: [https://silvertrade.ai](https://silvertrade.ai)
**GitHub**: [https://github.com/silvertrade/silvertrade](https://github.com/silvertrade/silvertrade)
**Documentation**: [https://docs.silvertrade.ai](https://docs.silvertrade.ai)

## The Problem SilverTrade AI Solves
...
TradingView sends a signal
        ↓
SilverTrade receives it instantly
        ↓
...
| **Python Strategy Hosting** | Host and schedule Python strategies directly in SilverTrade AI |
...
**Benefit**: Switch brokers without changing your strategy code - SilverTrade's unified API handles the translation.
...
## What SilverTrade AI is NOT

Let's be clear about what SilverTrade AI doesn't do:
...
1. **Next**: Learn [Why Build with SilverTrade](../02-why-build-with-silvertrade/README.md)
...
| Resource | Link |
|----------|------|
| **GitHub** | [github.com/silvertrade/silvertrade](https://github.com/silvertrade/silvertrade) |
...
**Next**: [02 - Why Build with SilverTrade](../02-why-build-with-silvertrade/README.md) - Understand the value proposition.
