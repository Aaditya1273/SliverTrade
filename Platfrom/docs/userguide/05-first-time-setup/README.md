...
You've installed SilverTrade AI. Now let's configure it properly for secure operation and connect it to your broker.

## Setup Wizard Overview

When you first access SilverTrade, you'll go through these steps:
...
## Step 1: Access SilverTrade

1. Start SilverTrade AI:
   ```bash
   uv run app.py
   ```
...
Before using SilverTrade, you MUST set unique security keys.
...
4. Authorize SilverTrade
5. You'll be redirected back to SilverTrade
...
Congratulations! SilverTrade AI is now set up. Your next steps:
