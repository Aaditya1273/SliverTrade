# 02 - Why Build with SilverTrade?

*"Why should I use SilverTrade AI when I can just build my strategy directly on top of the broker's SDK or API?"*
...
**SilverTrade takes care of the heavy lifting.**
...
## What Makes SilverTrade AI Different?

### Strategy Management & Hosting

Host your **Python strategies directly inside SilverTrade**, alongside strategies from TradingView, Amibroker, ChartInk, MetaTrader, Excel, or custom webhooks. Start, pause, schedule, monitor, and analyze—all from a central control plane.
...
SilverTrade supports **29 Indian brokers** via a **unified API and WebSocket layer**. Write your strategy once, and run it across Zerodha, Angel One, Dhan, Upstox, Fyers, Flattrade, Firstock, and more—without rewriting code.
...
With SilverTrade's **Common Symbol Format**, you don't have to worry about broker-specific quirks. Contracts, expiries, and lot sizes are maintained automatically.

| Broker | Their Format | SilverTrade AI Format |
|--------|--------------|-----------------|
| Zerodha | `SBIN` | `SBIN` |
| Angel | `SBIN-EQ` | `SBIN` |
| Dhan | `SBIN` | `SBIN` |
...
SilverTrade is production-tested with enterprise-grade security:
...
| Component | What You'd Build | SilverTrade AI Provides |
|-----------|------------------|-------------------|
...
SilverTrade ships with all this—**pre-wired, tested, and open source**.

---

## Open Source Freedom

Licensed under **AGPL**, SilverTrade AI gives you:
...
| Aspect | Broker APIs | SilverTrade AI |
|--------|-------------|----------|
...
**SilverTrade gives you *infrastructure*.**
...
And when you're ready to switch brokers or expand to multi-broker setups, you'll already be on **SilverTrade's unified, broker-agnostic foundation**.

---

**Previous**: [01 - What is SilverTrade](../01-what-is-silvertrade/README.md)
