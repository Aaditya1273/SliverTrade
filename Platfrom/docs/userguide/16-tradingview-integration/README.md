...
TradingView is a popular charting platform with powerful Pine Script strategy capabilities. SilverTrade AI connects TradingView alerts to your broker for automated order execution.

## How It Works

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    TradingView → SilverTrade AI Flow                              │
│                                                                              │
│  ┌─────────────┐     ┌─────────────┐     ┌─────────────┐     ┌──────────┐  │
│  │ TradingView │     │   Webhook   │     │  SilverTrade AI   │     │  Broker  │  │
...
TradingView webhooks need to reach your SilverTrade AI server from the internet.
...
```pine
//@version=5
strategy("My SilverTrade AI Strategy", overlay=true)
...
```
https://your-silvertrade-url/api/v1/placesmartorder
```
...
| TradingView | SilverTrade AI Exchange |
|-------------|-------------------|
...
1. Go to **Analyzer** page in SilverTrade
...
- Keep SilverTrade AI dashboard open
