...
<html>
<head>
    <title>System Health Monitor - SilverTrade</title>
    <!-- Add your styles -->
</head>
<body>
    <div class="container">
...
tail -f logs/silvertrade.log | grep -i health
...
fd_gauge = Gauge('silvertrade_fd_count', 'File descriptor count')
memory_gauge = Gauge('silvertrade_memory_mb', 'Memory usage in MB')
