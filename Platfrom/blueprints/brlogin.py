...
def samco_ip_status():
    ...
    from database.auth_db import (
        samco_get_ip_status as get_ip_status,
        samco_has_secret_key as has_secret_key,
    )
...
def samco_update_ip():
    ...
    from database.auth_db import (
        samco_get_ip_status as get_ip_status,
        samco_has_registered_ip as has_registered_ip,
        samco_save_ip_info as save_ip_info,
    )
