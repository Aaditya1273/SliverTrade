...
GoCharting is a professional HTML5 charting platform optimized for Indian markets. With a **Premium Plan**, you can set up webhook alerts to automate your trading strategies with SilverTrade AI.
...
### 2. SilverTrade AI Setup
- SilverTrade AI instance running and accessible
- API key configured in SilverTrade
...
If you're running SilverTrade AI locally (on your computer) and want to test webhooks, you'll need to expose your local server to the internet using a tunneling service.
...
2. Start the tunnel pointing to port 5000 (SilverTrade's default port)
3. Copy the public URL provided by the tunneling service
4. Update your `.env` file:
   ```env
   HOST_SERVER=https://your-tunnel-url.com
   ```
5. Restart SilverTrade AI application
...
1. **Login to SilverTrade**
   - Navigate to your SilverTrade AI dashboard
...
5. **Configure Delivery Methods**
   ...
   - ☑️ **Webhook**: Enable this for SilverTrade AI integration

   **Webhook URL**: Paste your SilverTrade AI webhook URL
   ```
   https://yourdomain.com/api/v1/placeorder
   ```
...
1. **Enable Sandbox Mode in SilverTrade**
...
1. Enable **Analyze Mode** in SilverTrade AI (toggle in navbar)
2. Create a test alert in GoCharting with a condition that will trigger immediately
3. Check the **API Analyzer** in SilverTrade AI to see the incoming request
...
```json
{
  "apikey": "your_api_key_here",      // Your SilverTrade AI API key
...
|-------|----------|-------------|--------------|
| apikey | Yes | Your SilverTrade AI API key | String |
...
4. Ensure SilverTrade AI is running and accessible from internet

### Issue: Orders not placing

**Solutions:**
1. Verify API key is correct in the JSON payload
2. Check broker connection in SilverTrade AI dashboard
3. Verify sufficient funds in trading account
4. Check symbol format matches your broker's convention
5. Review logs in SilverTrade AI (Logs menu)

### Issue: "API key not found" error

**Solutions:**
1. Go to SilverTrade AI → API Key section
...
4. **Test tunnel accessibility**
   ...
   - You should see SilverTrade AI login page
...
### 3. Monitor Activity
- Regularly check order logs in SilverTrade
...
SilverTrade has rate limiting to prevent abuse:
...
### Documentation
- SilverTrade AI Docs: https://docs.silvertrade.ai
- GoCharting Help: https://gocharting.com/help

### Community
- SilverTrade AI GitHub: https://github.com/silvertrade/silvertrade
- Report Issues: https://github.com/silvertrade/silvertrade/issues

### Video Tutorials
- Check SilverTrade AI YouTube channel for video guides
...
A: Check the Logs section in SilverTrade AI or use the API Analyzer in Analyze Mode.
...
**Happy Trading with GoCharting and SilverTrade! 🚀**
