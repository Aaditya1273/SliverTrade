...
// Convert DD-MMM-YYYY (API-returned expiry) to DDMMMYY (SilverTrade AI symbol format).
...
export default function StrategyBuilder() {
  ...
  // SilverTrade AI-symbol → tick size map, built from the live option chain.
  ...
  // Expiries are normalised to the SilverTrade AI DDMMMYY format at the source so that
  ...
  const saveEditedLeg = useCallback(
    (updated: StrategyLeg) => {
      // Normalise expiry to the SilverTrade AI DDMMMYY format — the dropdown may
