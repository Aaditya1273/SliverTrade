...
This is a minimal example showing how to use the SilverTrade AI Python SDK.
"""
  ...
  return (
    <div className="container mx-auto py-6 max-w-2xl space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Your Python script should use the <code className="bg-muted px-1 rounded">silvertrade</code>{' '}
          SDK. Install it with: <code className="bg-muted px-1 rounded">pip install silvertrade</code>
        </AlertDescription>
      </Alert>
