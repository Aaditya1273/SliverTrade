...
===============================================================================
                EMA CROSSOVER WITH FIXED DATETIME HANDLING
                            SilverTrade AI Trading Bot
===============================================================================

Run standalone:
    export SILVERTRADE_API_KEY="your-api-key"
    python emacrossover_strategy_python.py

Run via SilverTrade AI's /python strategy runner:
    SILVERTRADE_API_KEY            : injected per-strategy (PR #1247).
    SILVERTRADE_STRATEGY_EXCHANGE  : set from the strategy's \`exchange\` config
    ...
    HOST_SERVER / WEBSOCKET_URL : inherited from SilverTrade AI's .env.
...
# When launched via SilverTrade AI's /python runner, these come from the platform:
#   SILVERTRADE_API_KEY : injected per-strategy (decrypted from DB)
#   HOST_SERVER      : inherited from SilverTrade AI's .env
#   WEBSOCKET_URL    : inherited from SilverTrade AI's .env
API_KEY = os.getenv("SILVERTRADE_API_KEY", "silvertrade-apikey")
...
# Exchange — reads SILVERTRADE_STRATEGY_EXCHANGE so your script
    ...
    <div className="container mx-auto py-6 space-y-6 max-w-4xl">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Self-host automated trading strategies inside SilverTrade AI. Each strategy runs as an
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4">
            <div className="flex gap-4">
              ...
              <div>
                <p className="font-medium">Install SilverTrade AI SDK</p>
                <div className="mt-1 flex items-center gap-2">
                  <code className="bg-muted px-2 py-1 rounded text-sm">pip install silvertrade</code>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => copyToClipboard('pip install silvertrade')}
                  >
                    Copy
                  </Button>
                </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  and copy your SilverTrade AI API key
                </p>
              </div>
            </div>
            <div className="flex gap-4">
        ...
        <CardContent className="space-y-4 text-sm">
          <div className="space-y-3">
            ...
            <div className="bg-muted p-3 rounded-lg">
              ...
              <p className="text-muted-foreground">
                The host injects <code>SILVERTRADE_API_KEY</code>, <code>STRATEGY_ID</code>,{' '}
                <code>STRATEGY_NAME</code>, and <code>SILVERTRADE_STRATEGY_EXCHANGE</code> into
      ...
      <Card>
        ...
        <CardContent className="space-y-5">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-muted-foreground">
                  <tr className="border-b">
                    <td className="py-2 pr-4"><code>SILVERTRADE_API_KEY</code></td>
                  ...
                  <tr className="border-b">
                    <td className="py-2 pr-4"><code>SILVERTRADE_STRATEGY_EXCHANGE</code></td>
                    <td className="py-2">
                  ...
                  <tr className="border-b">
                    <td className="py-2 pr-4"><code>SILVERTRADE_HOST</code></td>
                    <td className="py-2">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Strategies inherit every variable from SilverTrade AI's <code>.env</code> via{' '}
              <code>os.environ.copy()</code>. The key ones for connecting back to SilverTrade AI:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
          ...
          <Alert>
            <AlertTitle>Reading SILVERTRADE_STRATEGY_EXCHANGE is strongly recommended</AlertTitle>
            <AlertDescription>
          ...
          <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    ...
                    <p className="mt-1">
                      Log in to SilverTrade AI before the session, wait for master contracts to download,
            ...
            <AccordionItem value="master-contract">
              ...
              <AccordionContent className="text-muted-foreground space-y-2">
                ...
                <ol className="list-decimal list-inside space-y-1 ml-2">
                  <li>Log in to SilverTrade AI</li>
            ...
            <AccordionItem value="resource-limits">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  ...
                  crashing SilverTrade AI. On Windows, these are not enforced at the OS level.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
            ...
            <AccordionItem value="restart">
              <AccordionTrigger>
                What happens if I restart SilverTrade AI?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>SilverTrade AI handles restarts gracefully:</p>
                <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <AccordionItem value="best-practices">
              ...
              <AccordionContent className="text-muted-foreground space-y-2">
                <ul className="list-disc list-inside space-y-2 ml-2">
                  ...
                  <li>
                    <strong>Read SILVERTRADE_STRATEGY_EXCHANGE</strong> &mdash; Wire the exchange from
                ...
                <div className="space-y-4">
                  <div className="bg-muted p-3 rounded-lg">
                    ...
                    <ol className="list-decimal list-inside space-y-1 ml-2 text-sm">
                      ...
                      <li>
                        Run <code>uv sync</code> in the silvertrade directory
                      </li>
                      <li>Restart SilverTrade AI</li>
                    </ol>
                  </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    ...
                    <p className="mt-1">
                      ...
                      <code>exchange="MCX"</code>. Read <code>SILVERTRADE_STRATEGY_EXCHANGE</code> in your
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    <p className="font-medium">SILVERTRADE_API_KEY not set</p>
                    <p className="mt-1">
      ...
      <Card>
        <CardHeader>
          <CardTitle>SilverTrade AI SDK Quick Reference</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
