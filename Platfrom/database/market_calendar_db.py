...
def get_holiday_exchange_window(query_date: date, exchange: str) -> Optional[Dict[str, Any]]:
    """
...
def get_effective_session_window(query_date: date, exchange: str) -> Optional[Dict[str, Any]]:
    """
