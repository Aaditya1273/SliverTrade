...
This strategy demonstrates how to integrate with SilverTrade API
"""
...
# When this strategy is launched via SilverTrade's /python runner,
# SILVERTRADE_API_KEY is injected by the platform and HOST_SERVER /
# WEBSOCKET_URL are inherited from SilverTrade's .env file.
api_key = os.getenv('SILVERTRADE_API_KEY')
host    = os.getenv('HOST_SERVER', 'http://127.0.0.1:5000')
ws_url  = os.getenv('WEBSOCKET_URL', 'ws://127.0.0.1:8765')

if not api_key:
    print("Error: SILVERTRADE_API_KEY environment variable not set")
    exit(1)


# Set the strategy details and trading parameters
strategy = "EMA Crossover Python"
symbol = 'NHPC'  # SilverTrade Symbol
exchange = "NSE"
product = "MIS"
quantity = 1
