...
# ─── Product / Order type mappings (SilverTrade ↔ AliceBlue V2) ──────────────────


def map_product_type(product):
    """Map SilverTrade AI product type to AliceBlue V2 product type."""
    mapping = {
        "CNC": "LONGTERM",
        "NRML": "NRML",
        "MIS": "INTRADAY",
...
def reverse_map_product_type(product):
    """Map AliceBlue V2 product type back to SilverTrade AI product type."""
    mapping = {
        "LONGTERM": "CNC",
        "NRML": "NRML",
        "INTRADAY": "MIS",
...
def map_order_type(pricetype):
    """Map SilverTrade AI price type to AliceBlue V2 order type."""
    mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
        "SL": "SL",
...
def reverse_map_order_type(order_type):
    """Map AliceBlue V2 order type back to SilverTrade AI price type."""
    mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
        "SL": "SL",
...
# ─── Payload builders (SilverTrade request → AliceBlue V2 API payload) ──────────


def transform_data(data):
    """
    Transform an SilverTrade AI place-order request into an AliceBlue V2 API payload item.
    """
    ...
    return {
        ...
        "apiOrderSource": "",
        "algoId": "",
        "orderTag": "silvertrade",
    }


def transform_modify_order_data(data):
    """
    Transform an SilverTrade AI modify-order request into an AliceBlue V2 API modify payload.
    """
    return {
