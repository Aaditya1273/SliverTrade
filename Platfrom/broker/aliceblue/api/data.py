...
class BrokerData:
    ...
    def _map_exchange(self, exchange: str) -> str:
        """Map SilverTrade exchange codes to AliceBlue API exchange codes."""
        exchange_map = {
            "NSE_INDEX": "NSE",
            "BSE_INDEX": "BSE",
            "MCX_INDEX": "MCX",
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Returns:
            dict: Quote data in SilverTrade standard format
        """
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Return in SilverTrade standard format (matching Angel broker)
            return {
                "bids": bids,
                "asks": asks,
        ...
        try:
            ...
            try:
                response = request_with_circuit_breaker(
                    "POST", HISTORICAL_API_URL, headers=headers, json=payload, timeout=15
                )
