...
class IiflExchangeMapper:
    """Maps between SilverTrade AI exchange codes and Iifl XTS specific exchange types"""

    # Exchange type mapping for Iifl XTS broker
    # Format: {SilverTrade_Exchange: Iifl_Exchange_Code}
    ...
    # Reverse mapping for converting Iifl exchange codes to SilverTrade AI format
    # Format: {Iifl_Exchange_Code: SilverTrade_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert SilverTrade AI exchange code to Iifl XTS specific exchange type
    ...
    @staticmethod
    def get_silvertrade_exchange(iifl_code):
        """
        Convert Iifl XTS exchange code to SilverTrade AI exchange code
