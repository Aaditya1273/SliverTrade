...
class BrokerData:
    ...
    def _get_quotes_via_chart(
        ...
        dummy_oi = (
            int(hashlib.sha256(str(security_id).encode()).hexdigest()[:8], 16) % 100000 + 1000
        )
    ...
    def _parse_option_contract(self, symbol: str):
        """
        Parse option symbol in SilverTrade format.
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Return depth data in common format matching SilverTrade REST API response
            return {
                "bids": bids,
                "asks": asks,
