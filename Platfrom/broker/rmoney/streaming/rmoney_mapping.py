...
class RMoneyExchangeMapper:
    """Maps between SilverTrade AI exchange codes and RMoney XTS specific exchange types"""

    # Exchange type mapping for RMoney XTS broker
    # Format: {SilverTrade_Exchange: RMoney_Exchange_Code}
    ...
    # Reverse mapping for converting RMoney exchange codes to SilverTrade AI format
    # Format: {RMoney_Exchange_Code: SilverTrade_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert SilverTrade AI exchange code to RMoney XTS specific exchange type
    ...
    @staticmethod
    def get_silvertrade_exchange(rmoney_code):
        """
        Convert RMoney XTS exchange code to SilverTrade AI exchange code
