...
class DeltaExchangeMapper:
    """Maps SilverTrade AI exchange codes to Delta Exchange equivalents.

    Delta Exchange uses plain symbol strings (e.g. "BTCUSD").
    All products trade on a single exchange named "CRYPTO" in SilverTrade AI.
    """
...
class DeltaModeMapper:
    """Maps SilverTrade AI subscription mode integers to Delta Exchange channel names."""
