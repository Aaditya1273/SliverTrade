...
def map_order_data(order_data):
    """
    Normalises a list of Delta Exchange order dicts to the SilverTrade AI internal format.
...
def map_trade_data(trade_data):
    """
    Normalises a list of Delta Exchange fill/trade dicts to the SilverTrade AI internal format.
...
def transform_tradebook_data(tradebook_data):
    """
    Transform Delta Exchange fill/trade data to SilverTrade AI standard format.
...
def map_position_data(position_data):
    """
    Normalises a list of Delta Exchange position dicts to the SilverTrade AI internal format.
...
def transform_positions_data(positions_data):
    ...
    SilverTrade AI Standard Fields:
    ...
    try:
        ...
        for position in positions_data:
            ...
            # SilverTrade AI standard format (matching Angel broker structure)
            transformed_position = {
                ...
                ),  # Float as per SilverTrade AI standard
