...
# Mapping SilverTrade AI margin positions to Delta Exchange margin_required API format
...
def transform_margin_positions(positions):
    """
    Transform SilverTrade AI margin position list to Delta Exchange format.

    Each SilverTrade AI position is converted to a dict with the fields needed
    ...
    Args:
        positions: List of dicts in SilverTrade AI format
...
def parse_margin_response(response_data):
    ...
    SilverTrade AI margin format (3 fields):
