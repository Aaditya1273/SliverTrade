# api/funds.py
# Delta Exchange wallet balance → SilverTrade AI margin format
# Endpoints:
...
def get_margin_data(auth_token):
    """
    Fetch wallet balance from Delta Exchange and return it in SilverTrade AI margin format.
    ...
    Args:
        auth_token (str): api_key stored in SilverTrade AI auth DB after login.
