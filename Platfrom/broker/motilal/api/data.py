...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Args:
            symbol: Trading symbol (SilverTrade format)
        ...
        try:
            ...
            # Map SilverTrade exchange to Motilal exchange
            ...
            # Return quote in SilverTrade common format
            return {
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        This follows the SilverTrade standard structure matching Angel and other brokers.
        ...
        Returns:
            dict: Market depth data in SilverTrade standard format
        """
        ...
        try:
            ...
            # Create a normalized depth structure in the SilverTrade format
            ...
            # Return in Angel's SilverTrade standard format (matching lines 524-537 of angel/api/data.py)
            return {
                "bids": formatted_bids,
                "asks": formatted_asks,
                "high": high,
