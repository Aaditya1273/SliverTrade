...
def process_pocketful_mcx_csv(path):
    ...
    # Define the function to build SilverTrade symbol
    def build_silvertrade_symbol(row):
        try:
    ...
    df["symbol"] = df.apply(build_silvertrade_symbol, axis=1)
