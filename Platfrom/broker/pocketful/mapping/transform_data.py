...
def transform_data(data, client_id=None, auth_token=None):
    """
    Transforms SilverTrade AI order format to Pocketful order format.
    ...
    Args:
        data: SilverTrade AI order data dictionary
...
def transform_modify_order_data(data, client_id=None):
    """
    Transforms SilverTrade AI order modification format to Pocketful order format.
...
def map_order_type(pricetype):
    """
    Maps SilverTrade AI pricetype to Pocketful order type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
...
def map_product_type(product):
    """
    Maps SilverTrade AI product type to Pocketful product type.
    """
...
def reverse_map_product_type(exchange, product):
    """
    Reverse maps the broker product type to the SilverTrade AI product type, considering the exchange.
    """
    # Exchange to SilverTrade AI product type mapping for 'D'
    exchange_mapping = {
        "CNC": "CNC",
        "NRML": "NRML",
        "MIS": "MIS",
