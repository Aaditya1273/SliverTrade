...
def transform_data(data, token):
    """
    Transforms the SilverTrade AI API request structure to Indmoney API structure.
    ...
    # Basic mapping from SilverTrade AI to Indmoney
...
def transform_modify_order_data(data):
    """
    Transforms SilverTrade AI modify order data to Indmoney format.
    """
    transformed = {
...
def map_order_type(pricetype):
    """
    Maps SilverTrade AI pricetype to Indmoney order_type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
...
def map_exchange(br_exchange):
    """
    Maps Indmoney exchange back to SilverTrade AI exchange.
    """
...
def reverse_map_product_type(product):
    """
    Maps Indmoney product type back to SilverTrade AI product type.
    """
