...
class IndmoneyExchangeMapper:
    """Maps SilverTrade AI exchange codes to INDmoney-specific segment codes"""
...
class IndmoneyModeMapper:
    ...
    # Mode mapping: SilverTrade AI mode number -> INDmoney mode string
    MODE_MAP = {
    ...
    def get_indmoney_mode(mode):
        """
        Convert SilverTrade AI mode number to INDmoney mode string

        Args:
            mode (int): SilverTrade AI mode (1: LTP, 2: Quote)
    ...
    @staticmethod
    def get_silvertrade_mode(indmoney_mode):
        """
        Convert INDmoney mode string to SilverTrade AI mode number

        Args:
            indmoney_mode (str): INDmoney mode ('ltp' or 'quote')

        Returns:
            int: SilverTrade AI mode number
        """
