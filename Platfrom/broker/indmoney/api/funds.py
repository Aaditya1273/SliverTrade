...
# Default response format for margin data (SilverTrade standard format)
...
def get_margin_data(auth_token):
    ...
    try:
        ...
        try:
            ...
            # SilverTrade AI standard required keys (matching Angel broker format)
            required_keys = [
                "availablecash",
                "collateral",
                "m2mrealized",
            ...
            # Prepare the response in SilverTrade AI standard format
            processed_data = {}

            # Map INDmoney fields to SilverTrade AI standard fields
            field_mapping = {
