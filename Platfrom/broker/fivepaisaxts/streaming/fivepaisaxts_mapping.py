...
class FivepaisaXTSExchangeMapper:
    """Maps between SilverTrade AI exchange codes and Fivepaisa XTS specific exchange types"""

    # Exchange type mapping for Fivepaisa XTS broker
    # Format: {SilverTrade_Exchange: Fivepaisa_Exchange_Code}
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to SilverTrade AI format
    # Format: {Fivepaisa_Exchange_Code: SilverTrade_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert SilverTrade AI exchange code to Fivepaisa XTS specific exchange type
    ...
    @staticmethod
    def get_silvertrade_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to SilverTrade AI exchange code
