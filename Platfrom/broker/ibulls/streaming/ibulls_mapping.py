...
class IbullsExchangeMapper:
    """Maps between SilverTrade AI exchange codes and Ibulls XTS specific exchange types"""

    # Exchange type mapping for Ibulls XTS broker
    # Format: {SilverTrade_Exchange: iBulls_Exchange_Code}
    ...
    # Reverse mapping for converting iBulls exchange codes to SilverTrade AI format
    # Format: {iBulls_Exchange_Code: SilverTrade_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert SilverTrade AI exchange code to Ibulls XTS specific exchange type
    ...
    @staticmethod
    def get_silvertrade_exchange(ibulls_code):
        """
        Convert Ibulls XTS exchange code to SilverTrade AI exchange code
