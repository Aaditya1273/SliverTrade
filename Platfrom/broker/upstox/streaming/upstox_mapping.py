...
class UpstoxExchangeMapper:
    """Maps between SilverTrade AI exchange codes and Upstox specific exchange types"""

    # Exchange type mapping for Upstox broker
    # Format: {SilverTrade_Exchange: Upstox_Exchange_Code}
    EXCHANGE_TYPES = {
        # NSE Segments
    ...
    # Reverse mapping for converting Upstox exchange codes to SilverTrade AI format
    # Format: {Upstox_Exchange_Code: SilverTrade_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert SilverTrade AI exchange code to Upstox specific exchange type
    ...
    @staticmethod
    def get_silvertrade_exchange(upstox_code):
        """
        Convert Upstox exchange code to SilverTrade AI exchange code
