...
class CompositedgeExchangeMapper:
    """Maps between SilverTrade AI exchange codes and Compositedge XTS specific exchange types"""

    # Exchange type mapping for Compositedge XTS broker
    # Format: {SilverTrade_Exchange: Compositedge_Exchange_Code}
    ...
    # Reverse mapping for converting Compositedge exchange codes to SilverTrade AI format
    # Format: {Compositedge_Exchange_Code: SilverTrade_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert SilverTrade AI exchange code to Compositedge XTS specific exchange type
    ...
    @staticmethod
    def get_silvertrade_exchange(compositedge_code):
        """
        Convert Compositedge XTS exchange code to SilverTrade AI exchange code

        Args:
            compositedge_code (int): Compositedge exchange code

        Returns:
            str: SilverTrade AI exchange code
        """
