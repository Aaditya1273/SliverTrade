...
def map_order_data(order_data):
    ...
    Returns:
    - The modified order_data normalized to SilverTrade AI format.
    """
    ...
    for order in orders:
        ...
        # Map Nubra fields to SilverTrade/Angel-like format
        ...
        # For SilverTrade AI we need: MARKET, LIMIT, SL, SL-M (uppercase like Angel)
...
def transform_tradebook_data(tradebook_data):
    """
    Transform normalized trade data to final SilverTrade AI UI format.
    """
    transformed_data = []
...
def map_position_data(position_data):
    """
    Map Nubra's positions response to SilverTrade AI normalized format.
    ...
    if isinstance(position_data, dict):
        ...
        for pos in merged_positions.values():
            ...
            # Map product type from Nubra format to SilverTrade AI format
            product = pos.get("product", "")
...
def transform_holdings_data(holdings_data):
    """
    Transform mapped Nubra holdings data to final SilverTrade AI UI format.
...
def map_portfolio_data(portfolio_data):
    ...
    Symbols are mapped to SilverTrade AI format via get_oa_symbol().
    ...
    for h in raw_holdings:
        ...
        # Look up SilverTrade AI symbol from database using ref_id or broker symbol
