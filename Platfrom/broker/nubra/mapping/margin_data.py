...
def transform_margin_positions(positions):
    """
    Transform SilverTrade AI margin position format to Nubra margin format.
...
def map_product_type(product):
    """
    Maps SilverTrade AI product type to Nubra order_delivery_type.
    """
    mapping = {
...
def map_order_side(action):
    """
    Maps SilverTrade AI action to Nubra order_side.
    """
    mapping = {
        "BUY": "ORDER_SIDE_BUY",
...
def map_price_type(pricetype):
    """
    Maps SilverTrade AI pricetype to Nubra price_type.
    """
    mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
...
def map_order_type(pricetype):
    """
    Maps SilverTrade AI pricetype to Nubra order_type.
    """
    mapping = {
...
def parse_margin_response(response_data):
    """
    Parse Nubra margin calculator response to SilverTrade AI standard format.
    ...
    try:
        ...
        # Return standardized format match SilverTrade AI API specification
        return {
            "status": "success",
            "data": {
