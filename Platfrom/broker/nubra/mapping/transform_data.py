...
def map_order_side(action):
    """
    Maps SilverTrade AI action (BUY/SELL) to Nubra order_side.
    """
    side_mapping = {
        "BUY": "ORDER_SIDE_BUY",
...
def map_product_type(product):
    """
    Maps SilverTrade AI product type to Nubra's internal product type for position lookup.
...
def reverse_map_product_type(product):
    """
    Maps Nubra's order_delivery_type back to SilverTrade AI product type.
    """
