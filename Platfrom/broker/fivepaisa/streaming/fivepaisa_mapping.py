...
class FivePaisaExchangeMapper:
    """Maps SilverTrade AI exchange codes to 5Paisa-specific exchange codes"""
    ...
    def get_exchange_code(exchange: str) -> str:
        """
        Convert SilverTrade AI exchange code to 5Paisa exchange code

        Args:
            exchange (str): SilverTrade AI exchange code (e.g., 'NSE', 'BSE', 'NFO')
    ...
    def get_exchange_type(exchange: str) -> str:
        """
        Convert SilverTrade AI exchange to 5Paisa exchange type
