...
def transform_data(data):
    """
    Transforms the SilverTrade AI Platform API request structure to the format expected by the Fyers API.
    """
...
def map_order_type(pricetype):
    """
    Maps the SilverTrade AI pricetype to the Fyers order type.
    """
...
def map_action(action):
    """
    Maps the SilverTrade AI action to the Fyers side.
    """
...
def map_product_type(product):
    """
    Maps the SilverTrade AI product type to the Fyers product type.
    """
...
def reverse_map_product_type(product):
    """
    Reverse maps the Fyers product type to the SilverTrade AI product type.
    """
    ...
    if oa_product is None:
        logger.warning(
            f"Unknown Fyers product type '{product}' received. Cannot map to SilverTrade AI product type."
        )
    return oa_product
