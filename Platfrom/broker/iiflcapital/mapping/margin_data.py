...
def transform_margin_positions(positions):
    """
    Transform SilverTrade AI margin positions to IIFL Capital span/exposure format.
...
def parse_margin_response(response_data):
    """
    Parse IIFL Capital span/exposure response to SilverTrade AI standard format.
