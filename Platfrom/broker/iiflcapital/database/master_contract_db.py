...
def format_strike(strike_val):
    """Format strike price for SilverTrade symbol. Integer if whole number, else decimal."""
    try:
...
def process_iiflcapital_indices_csv(path):
    ...
    # Determine SilverTrade exchange from CSV Exchange column
