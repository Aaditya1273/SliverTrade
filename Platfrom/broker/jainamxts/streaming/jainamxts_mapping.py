...
class JainamXTSExchangeMapper:
    """Maps between SilverTrade AI exchange codes and JainamXTS specific exchange types"""

    # Exchange type mapping for JainamXTS broker
    # Format: {SilverTrade_Exchange: JainamXTS_Exchange_Code}
    ...
    # Reverse mapping for converting JainamXTS exchange codes to SilverTrade AI format
    # Format: {JainamXTS_Exchange_Code: SilverTrade_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert SilverTrade AI exchange code to JainamXTS specific exchange type
    ...
    @staticmethod
    def get_silvertrade_exchange(jainamxts_code):
        """
        Convert JainamXTS exchange code to SilverTrade AI exchange code
