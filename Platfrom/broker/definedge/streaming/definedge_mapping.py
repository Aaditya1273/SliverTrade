...
class DefinedgeExchangeMapper:
    """Maps SilverTrade AI exchange codes to DefinEdge-specific exchange types"""
    ...
    def get_exchange_code(exchange):
        """
        Convert SilverTrade AI exchange code to DefinEdge exchange code

        Args:
            exchange (str): SilverTrade AI exchange code
