...
class AccountDeletionService:
    ...
    def initiate_deletion(self, user_id: int, password: str) -> tuple[bool, str]:
        ...
        try:
            ...
            return True, "Deletion scheduled. You will receive a confirmation email with a cancellation link."
        ...
        try:
            ...
            with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zip_file:
                for category, content in data.items():
                    zip_file.writestr(f"{category}.json", json.dumps(content, indent=2, default=str))
