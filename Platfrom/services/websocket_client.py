"""
Internal WebSocket client wrapper for connecting to the SilverTrade WebSocket server.
...
class WebSocketClient:
    """
    Internal WebSocket client for connecting to SilverTrade WebSocket server.
