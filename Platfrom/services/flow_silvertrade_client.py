# services/flow_silvertrade_client.py
"""
SilverTrade Client Wrapper for Flow
Provides SDK-like interface using internal SilverTrade AI services
"""
...
class FlowSilverTradeClient:
    """
    Client wrapper that provides SDK-like interface to SilverTrade AI services.
    ...
    def __init__(self, api_key: str):
        ...
        Args:
            api_key: The SilverTrade AI API key for authentication
        """
...
def get_flow_client(api_key: str) -> FlowSilverTradeClient:
    """
    Factory function to create a Flow SilverTrade AI client.

    Args:
        api_key: The SilverTrade AI API key

    Returns:
        FlowSilverTradeClient instance
    """
    return FlowSilverTradeClient(api_key)
