...
**Username Clarification**: The `username` parameter in the API refers to your **SilverTrade login username** (the username you use to login to the SilverTrade AI application), NOT your Telegram username (@handle).

- ✅ **Correct**: Use `"rajandran"` (your SilverTrade AI login username)
...
3. **User Must Be Linked**
   ...
   - Username must match your SilverTrade AI account username
...
4. **API Key and Username**
   ...
   - Replace `"your_username_here"` with your **SilverTrade login username** (the username you use to login to SilverTrade AI app)
   - **IMPORTANT**: Use SilverTrade AI username, NOT your Telegram username (@handle)
...
USERNAME = "your_username_here"      # Replace with your SilverTrade AI login username (NOT @telegram_handle)
```

**IMPORTANT**: `USERNAME` should be your SilverTrade AI login username (e.g., "rajandran"), NOT your Telegram username (e.g., "@rajandranr").
...
**Solution**:
1. Go to SilverTrade Telegram settings (`/telegram`)
2. Click "Start Bot"
...
4. **Ensure you're using SilverTrade AI login username, NOT Telegram username**
   - ✅ Correct: `"rajandran"` (SilverTrade login)
...
**Solution**:
1. Go to SilverTrade AI settings
2. Copy your API key
...
**Solution**:
1. Check bot status in SilverTrade AI dashboard
2. Verify username with `/status` in Telegram bot
3. Check SilverTrade AI logs for errors
...
- Check bot status in SilverTrade Telegram dashboard
- Verify user linking with `/status` in Telegram
- Review SilverTrade AI logs for detailed error messages
