#!/usr/bin/env python3
"""
Cross-platform CSRF Protection Test Suite for SilverTrade
...
class CSRFTester:
    ...
    def test_form_without_csrf(self):
        ...
        try:
            ...
            response = requests.post(
                urljoin(self.base_url, "/auth/login"), data=data, allow_redirects=False, timeout=10
            )
    ...
    def test_api_exemption(self):
        ...
        try:
            ...
            response = requests.get(
                urljoin(self.base_url, "/api/v1/orders"), headers=headers, timeout=10
            )
    ...
    def run_all_tests(self):
        """Run all CSRF tests"""
        print(f"\n{'=' * 60}")
        print("SilverTrade CSRF Protection Test Suite")
