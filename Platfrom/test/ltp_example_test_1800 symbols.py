"""
SilverTrade WebSocket LTP Example - 1800 Symbols Test
...
# Add parent directory to path to import silvertrade
...
try:
    ...
    print("Error: Could not import silvertrade. Make sure you're running from the correct directory.")
    sys.exit(1)
...
def main():
    print("SilverTrade WebSocket LTP Example - 1800 Symbols Test")
    print("=" * 60)
