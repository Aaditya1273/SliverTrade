...
1. Enable **Analyze Mode** in SilverTrade AI settings
2. Run the tests
...
1. Disable **Analyze Mode** in SilverTrade AI settings
2. Run the tests
...
**Solution**: Make sure SilverTrade AI is running at `http://127.0.0.1:5000`
...
{
  "status": "error",
  "message": "Invalid silvertrade apikey"
}
```

**Solution**: Replace API key in test file with your actual API key from SilverTrade AI settings
...
- Check SilverTrade AI logs for detailed error messages
