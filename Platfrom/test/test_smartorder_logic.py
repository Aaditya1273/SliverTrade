...
Usage:
    cd /Users/silvertrade/silvertrade-test/silvertrade
...
# ---------------------------------------------------------------------------
# Test data: the SilverTrade AI SmartOrder spec table
# ---------------------------------------------------------------------------
...
class TestSmartOrderPositionLogic:
    """Test the position calculation logic against the SilverTrade AI spec table."""
