...
from blueprints.signals import signals_bp  # Import the signals blueprint
...
def create_app():
    ...
    # Register RESTx API blueprint first to ensure it takes precedence over frontend catch-alls
    app.register_blueprint(api_v1_bp)
    # Exempt API endpoints from CSRF protection (they use API key authentication)
    csrf.exempt(api_v1_bp)

    # Register React frontend blueprint
    ...
    app.register_blueprint(signals_bp)  # Register Signals blueprint
