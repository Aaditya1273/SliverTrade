...
#### How to Apply
```bash
# Navigate to silvertrade directory
cd silvertrade
...
- Adds user linking between Telegram and SilverTrade
...
1. **Module not found errors**: Ensure you're running from the SilverTrade AI directory with virtual environment:
   ```bash
...
*For full documentation, see [SilverTrade Documentation](../docs/)*