...
Before installing SilverTrade, ensure you have the following prerequisites installed:
...
2. **Clone the Repository**: 
   Open the VS Code Terminal and clone the SilverTrade AI repository:
   ```bash
...
5. **Configure Environment Variables**: 
   - Rename `.sample.env` to `.env` in the `silvertrade` folder
...
For more detailed configuration instructions, visit [https://docs.silvertrade.ai](https://docs.silvertrade.ai)
