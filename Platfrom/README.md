# SilverTrade - Open Source Algorithmic Trading Platform

<div align="center">

[![PyPI Downloads](https://static.pepy.tech/badge/silvertrade)](https://pepy.tech/projects/silvertrade)
[![PyPI Downloads](https://static.pepy.tech/badge/silvertrade/month)](https://pepy.tech/projects/silvertrade)
[![X (formerly Twitter) Follow](https://img.shields.io/twitter/follow/openalgoHQ)](https://twitter.com/silvertradeHQ)
[![YouTube Channel Subscribers](https://img.shields.io/youtube/channel/subscribers/UCw7eVneIEyiTApy4RtxrJsQ)](https://www.youtube.com/@silvertrade)
...
SilverTrade is a free, open source, self-hosted **trading platform** — not just a broker bridge. Built on Python Flask + React 19, it gives traders a full-stack environment to **design, host, and execute strategies** across **30+ Indian brokers** through a single unified API. Whether you write Python, prefer drag-and-drop, or trade options exclusively, SilverTrade AI gives you a first-class workflow without tying you to any single broker or vendor.

SilverTrade is no longer just "an API layer in front of your broker." Today it is **four products in one self-hosted instance** — sharing one broker session, one WebSocket feed, and one database — covering the complete journey from idea → backtest → live trade.

## Four Ways to Trade with SilverTrade
...
[![What is SilverTrade](https://img.youtube.com/vi/LhbXWlUtCcM/0.jpg)](https://www.youtube.com/watch?v=LhbXWlUtCcM)

## Quick Links

- **Documentation**: [docs.silvertrade.ai](https://docs.silvertrade.ai)
- **Installation Guide**: [Getting Started](https://docs.silvertrade.ai/installation-guidelines/getting-started)
- **Upgrade Guide**: [Upgrade Instructions](https://docs.silvertrade.ai/installation-guidelines/getting-started/upgrade)
- **Why SilverTrade**: [Why Build with SilverTrade](https://docs.silvertrade.ai/why-to-build-with-silvertrade)
...
[API Analyzer Documentation](https://docs.silvertrade.ai/new-features/api-analyzer)
...
[Action Center Documentation](https://docs.silvertrade.ai/new-features/action-center)

### Python Strategy Host (`/python`)
Host and run your Python strategies directly inside SilverTrade AI — no separate VM, no cron, no Docker:
...
- Local and secure integration with your SilverTrade AI instance
...
[PnL Tracker Documentation](https://docs.silvertrade.ai/new-features/pnl-tracker)

[Traffic & Latency Monitor Documentation](https://docs.silvertrade.ai/new-features/traffic-latency-monitor)
...
SilverTrade provides officially supported client libraries for application development and system-level integrations:

| Language / Platform | Repository |
|---------------------|------------|
| Python | [silvertrade-python-library](https://github.com/silvertrade/silvertrade-python-library) |
| Node.js | [silvertrade-node](https://github.com/silvertrade/silvertrade-node) |
| Java | [silvertrade-java](https://github.com/silvertrade/silvertrade-java) |
| Rust | [silvertrade-rust](https://github.com/silvertrade/silvertrade-rust) |
| .NET / C# | [silvertrade.NET](https://github.com/silvertrade/silvertrade.NET) |
| Go | [silvertrade-go](https://github.com/silvertrade/silvertrade-go) |

## SilverTrade AI FOSS Ecosystem

SilverTrade is part of a larger open-source trading ecosystem:

- **SilverTrade Core**: This repository (Python Flask + React)
...
- **Documentation**: Comprehensive guides on [Gitbook](https://docs.silvertrade.ai/mini-foss-universe)
...
SilverTrade uses the modern `uv` package manager for faster, more reliable installations:

```bash
# Clone the repository
git clone https://github.com/silvertrade/silvertrade.git
cd silvertrade
...
For detailed installation instructions, deployment options (Docker, AWS, etc.), and configuration guides, visit [docs.silvertrade.ai/installation-guidelines/getting-started](https://docs.silvertrade.ai/installation-guidelines/getting-started)

## API Documentation

Complete API reference and examples:
- **API Documentation**: [docs.silvertrade.ai/api-documentation/v1](https://docs.silvertrade.ai/api-documentation/v1)
- **Symbol Format**: [docs.silvertrade.ai/symbol-format](https://docs.silvertrade.ai/symbol-format)
...
Comprehensive documentation is available at [docs.silvertrade.ai](https://docs.silvertrade.ai):
...
- **Discord**: [Join our community](https://www.silvertrade.ai/discord)
- **Twitter/X**: [@silvertradeHQ](https://twitter.com/silvertradeHQ)
- **YouTube**: [@silvertrade](https://www.youtube.com/@silvertrade)
- **GitHub Issues**: [Report bugs or request features](https://github.com/silvertrade/silvertrade/issues)

## License

SilverTrade is released under the **AGPL V3.0 License**. See [LICENSE](LICENSE) for details.

## Credits & Acknowledgments

SilverTrade is built upon the shoulders of giants. We extend our gratitude to all the open-source projects that make this platform possible.
