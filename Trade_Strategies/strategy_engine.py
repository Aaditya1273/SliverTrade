...
class StrategyEngine:
    ...
    def _analyze_impl(
        ...
        result = {
            ...
            "disclaimer": "This signal is generated by an automated algorithm and does not constitute financial advice. Investments involve risk of loss.",
            "signal_basis": "Technical analysis using RSI, EMA, MACD, Bollinger Bands, and ensemble voting with machine learning models trained on historical data.",
            "accuracy_disclosure": "Based on backtested data. Past performance is not indicative of future results.",
