    ...
    >
      <div className="max-w-[1400px] mx-auto text-center">
        ...
        >
          ...
          <span className="cta-word inline-block opacity-0" style={{ color: 'var(--accent)' }}>
            GO
          </span>
        </h2>
        ...
        <Link
          href="/signup"
          className="cta-button opacity-0 inline-block font-semibold text-base px-10 py-4 rounded-full transition-colors duration-200"
          style={{ backgroundColor: 'var(--inverse-fg)', color: 'var(--inverse-bg)' }}
        >
          Get started
        </Link>
      </div>
